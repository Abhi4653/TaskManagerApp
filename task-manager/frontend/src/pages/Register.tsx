      ...
      <div className="w-full max-w-md bg-white/90 backdrop-blur p-8 rounded-xl shadow-2xl">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <input className="border border-gray-300 rounded w-full p-2 focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Your name" value={name} onChange={e=>setName(e.target.value)} />
          </div>
          <div>
          ...
          <button className="w-full py-2 rounded bg-purple-600 text-white font-medium hover:bg-purple-700 transition">Create account</button>
        </form>
      </div>
    </div>
  );
